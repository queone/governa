...
- Verify behavior against documented contracts (`AGENTS.md`, `governa/release.md`, AC docs).
...
- When an AC is completed, consolidate its decisions into durable docs or code. The AC file is removed during release prep (see `governa/release.md` Pre-Release Checklist).
