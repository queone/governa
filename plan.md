...
- IE9: Simplification of `preptool` for smaller overlay footprint.
- IE10: Evaluate whether the embedded CHANGELOG is still needed now that the sync-review artifact is retired.
